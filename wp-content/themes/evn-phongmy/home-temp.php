...
<!-- tab content -->
<div class="web-tab-content hidden d-none" style="display: none;">
         <div class="w3-bar w3-black">
            <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event,'London')">Tại sao chọn chúng tôi</button>
            <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris')">Các bước vay tiền mặt</button>
            <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo')">Tab thứ 3</button>
            <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Hanoi')">Tab thứ 4</button>
         </div>
            ...
            <div class="contact-content">
               ...
               <form class="formdata" method="post" name="formdata">
                  ...
                  <span class="wrap_name">
                     <input required class="name" name="name" type="text" style="width: 100%" placeholder="Họ và tên"/>
                  </span>
                  ...
                  <div class="btn-hen-tuvan">
                     ...
                     <button class="hidden" type="reset"/>reset</button>
                      <!-- <img src="<?php //echo IMGPATH;?>right.png"> -->
                  </div>
               </form>
